...
import { LocalDeviceIcon, GoogleDriveIcon, BotBuilderIcon, QuickStrategyIcon } from './components/dashboard-icons';
...
const Cards = observer(({ is_mobile, has_dashboard_strategies }: TCardProps) => {
    ...
    const actions: TCardArray[] = [
        ...
        {
            id: 'quick-strategy',
            icon: <QuickStrategyIcon size={48} />,
    ...
    return React.useMemo(
        () => (
            ...
            >
                ...
                >
                    {actions.map(icons => {
                        const { icon, content, callback, id, glowClass } = icons;
                        return (
                            <div
                                key={id}
                                className={classNames('tab__dashboard__table__block', glowClass, {

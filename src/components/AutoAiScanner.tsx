...
function resolveSignalContract(selectedSignal: Signal | null, selectedTradeType: string) {
    ...
    return {
        ...
        prediction,
        hasPrediction,
        tradeTypeCat: defaults.tradeTypeCat,
...
function generateAutoAiBotXml({
    ...
    const predictionInput = hasPrediction
        ...
        : '';
    const beforePurchaseXml = buildEntryLogicSignal(
        selectedSignal,
        selectedTradeType,
        contractType,
        predictionValue,
                        ...
                        <div className='auto-ai-scanner__row'>
                                ...
                                <div className='auto-ai-scanner__field'>
                                    ...
                                    {showSymbolPicker && (
                                        <div className='auto-ai-scanner__picker'>
                                            {['Volatility', 'Crash/Boom', 'Jump', 'Bear/Bull', 'Range', 'Step'].map(
                                                cat => (
                                                    <div key={cat}>
                                                        ...
                                                        {SYMBOLS.filter(s => s.category === cat).map(s => (
                                                            <button
                                                                ...
                                                                className={classNames(
                                                                    'auto-ai-scanner__symbol-option',
                                                                    {
                                                                        'auto-ai-scanner__symbol-option--selected':
                                                                            selectedSymbol === s.id,
                                                                    }
                                                                )}
                                                                onClick={() => {
                                    ...
                                    {TRADE_TYPES.map(t => (
                                        <button
                                            ...
                                            className={classNames('auto-ai-scanner__trade-type-button', {
                                                'auto-ai-scanner__trade-type-button--active':
                            ...
                            <div className='auto-ai-scanner__note-card'>
                                <div>
                                    ...
                                    <div className='auto-ai-scanner__note-text'>
                                        Trade every tick generated on the bot builder
                                    </div>
                                </div>
                                <button
                                    type='button'
                            ...
                            <div className='auto-ai-scanner__action-row'>
                                <button
                                    type='button'
                                    className='auto-ai-scanner__button--secondary'
                                    onClick={resetScan}
                                >
                                    Cancel
                                </button>
                        ...
                        <div className='auto-ai-scanner__row'>
                            {selectedSignal && (
                                <div className='auto-ai-scanner__result-card'>
                                    <div>
                                        ...
                                        <p className='auto-ai-scanner__signal-recommendation'>
                            ...
                            <div>
                                <div className='auto-ai-scanner__signal-header'>
                                    ...
                                    {mwa?.aligned && (
                                        <span className='auto-ai-scanner__aligned-pill'>⚡ All windows aligned</span>
                                    )}
                                </div>
                                <div className='auto-ai-scanner__signal-list'>
                                    {combinedSignals.length > 0 ? (
                                                ...
                                                <div className='auto-ai-scanner__signal-card-body'>
                                                    ...
                                                    <div className='auto-ai-scanner__signal-info'>
                                                        <div className='auto-ai-scanner__signal-title'>
                                                            <span className='auto-ai-scanner__signal-label'>
                                                                {s.label}
                                                            </span>
                                                            {s.tradeDirection && (
                                                                <span
                                                                    className={classNames(
                                                                        'auto-ai-scanner__signal-pill',
                                                                        {
                                                                            'auto-ai-scanner__signal-pill--trade-now':
                                                                                s.status === 'TRADE NOW',
                                                                            'auto-ai-scanner__signal-pill--wait':
                                                                                s.status === 'WAIT',
                                                                            'auto-ai-scanner__signal-pill--label':
                                                                                s.status !== 'TRADE NOW' &&
                                                                                s.status !== 'WAIT',
                                                                        }
                                                                    )}
                                                            ...
                                                            {s.windowsAligned && (
                                                                <span className='auto-ai-scanner__aligned-pill'>
                                                                    ✓ ALIGNED
                                                                </span>
                                                            )}
                                                            {s.window && (
                                                                <span className='auto-ai-scanner__signal-window'>
                                                                    {s.window}T
                                                                </span>
                                                            )}
                                                        </div>
                                                    ...
                                                    <div className='auto-ai-scanner__signal-meta'>
                                                        <span
                                                            className={classNames('auto-ai-scanner__signal-status', {
                                                                'auto-ai-scanner__signal-status--trade-now':
                                                                    s.status === 'TRADE NOW',
                                                                'auto-ai-scanner__signal-status--wait':
                                                                    s.status === 'WAIT',
                                                                'auto-ai-scanner__signal-status--default':
                                                                    s.status !== 'TRADE NOW' && s.status !== 'WAIT',
                                                            })}
                                                        >
                                                            {s.status}
                                                        </span>
                                                        <span className='auto-ai-scanner__signal-probability'>
                                        ...
                                        <div className='auto-ai-scanner__empty-state'>
                                            ...
                                            <p className='auto-ai-scanner__empty-state-title'>
                                                No signals detected yet
                                            </p>
                                            <p className='auto-ai-scanner__empty-state-text'>
                            ...
                            <div className='auto-ai-scanner__panel-footer'>
                                ...
                                <button
                                    type='button'
                                    className='auto-ai-scanner__button--success'
                                    onClick={handleLoadBotInternal}
                                >
                                    ↓ Load Bot
                                </button>
                                <button
                                    type='button'
                                    className='auto-ai-scanner__button--primary'
                                    onClick={handleLoadAndRunInternal}
                                >
                                    ▶ Load & Run
                                </button>
                            </div>

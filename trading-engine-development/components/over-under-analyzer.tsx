        ...
        <div className='space-y-6'>
            ...
            >
                ...
                {(signal === 'TRADE' || signal === 'STRONG') && (
                    <>
                        <p
                            className={`text-sm font-bold mt-3 ${theme === 'dark' ? 'text-yellow-400' : 'text-yellow-600'}`}
                        >
            ...
            {(signal === 'TRADE' || signal === 'STRONG') && prediction && (
                ...
                >
                    <h3
                        className={`text-lg font-bold mb-3 ${theme === 'dark' ? 'text-yellow-400' : 'text-yellow-700'}`}
                    >
                        🎯 Best Predictions
                    </h3>

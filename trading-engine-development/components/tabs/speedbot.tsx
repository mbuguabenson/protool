            ...
            >
                ...
                <div className='space-y-3'>
                    {tradeTypes.length > 0 && (
                        <div>
                            <Label
                                className={`text-xs mb-1.5 block ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}
                            >
                                Trade Type
                            </Label>
                            <Select value={tradeType} onValueChange={setTradeType} disabled={isRunning}>
                                ...
                                <SelectContent
                                    className={theme === 'dark' ? 'bg-[#0a0e27] border-purple-500/30' : 'bg-white'}
                                >
                                    {tradeTypes.map(tt => (
                    ...
                    >
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                <span
                                    className={`text-xs font-bold ${botStatus === 'Idle' ? 'text-green-400' : 'text-yellow-400'}`}
                                >
                                    Status: {botStatus}
                                </span>
                            </div>

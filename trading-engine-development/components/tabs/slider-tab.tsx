            ...
            >
                ...
                <div className='grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-teal-500/20'>
                    <div>
                        ...
                        <div
                            className={`text-lg font-bold ${status === 'Running' ? 'text-emerald-400' : 'text-yellow-400'}`}
                        >
                            {status}
                        </div>
                    </div>
                    ...
                    <div className='space-y-4'>
                        ...
                        {transactions.length === 0 ? (
                            ...
                            transactions.map(tx => (
                                <div
                                    key={tx.id}
                                    className='grid grid-cols-3 gap-4 text-sm py-3 border-b border-gray-700/30'
                                >
                                    ...
                                    <div
                                        className={`font-bold ${tx.pnl.startsWith('+') ? 'text-green-400' : 'text-red-400'}`}
                                    >
                                        {tx.pnl}
                                    </div>
                                </div>

...
export function OverUnderTab({
    ...
    return (
        <div className='space-y-6'>
            ...
            >
                ...
                <div className='grid grid-cols-2 gap-6 mb-6'>
                    <div className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-blue-900/30' : 'bg-blue-50'}`}>
                        <div
                            className={`text-lg font-bold mb-2 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-800'}`}
                        >
                            Under (0-4)
                        </div>
                        <div
                            className={`text-4xl font-bold mb-2 ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`}
                        >
                    ...
                    <div className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-green-900/30' : 'bg-green-50'}`}>
                        <div
                            className={`text-lg font-bold mb-2 ${theme === 'dark' ? 'text-green-300' : 'text-green-800'}`}
                        >
                            Over (5-9)
                        </div>
                        <div
            ...
            >
              ...
              `}
                        ...
                        <div className='text-center'>
                            <span
                                className={`text-xl font-bold ${theme === 'dark' ? 'text-purple-400' : 'text-purple-600'}`}
                            >
                ...
                <div className='space-y-3'>
                    <div className='flex items-center gap-4'>
                        <div
                            className={`text-sm font-semibold w-32 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}
                        >
                            Over ({selectedDigit + 1}-9)
                        </div>
                        <div className='flex-1 relative'>
                            <div
                                className={`w-full rounded-full h-8 ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-200'}`}
                            >
                                <div
                    ...
                    {digitPower.digit === selectedDigit && (
                        <div
                            className={`text-center mt-2 p-2 rounded ${theme === 'dark' ? 'bg-orange-900/30' : 'bg-orange-50'}`}
                        >
                            <span
                                className={`text-sm font-semibold ${theme === 'dark' ? 'text-orange-400' : 'text-orange-600'}`}
                            >
                ...
                <div className='mt-6'>
                    <h4
                        className={`text-sm font-bold mb-3 text-center ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'}`}
                    >
            ...
            <div
                className={`rounded-xl p-2 px-4 border flex items-center justify-between gap-4 ${
                    theme === 'dark'

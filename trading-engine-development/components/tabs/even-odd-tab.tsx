            ...
            <div className='soft-card p-8 border-white/5'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
                    ...
                    >
                        ...
                        <div
                            className={`text-sm mb-4 font-semibold ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'}`}
                        >
                            EVEN (Current Power)
                        </div>
                    ...
                    >
                        <div className={`flex items-center justify-between mb-3`}>
                            <div
                                className={`text-5xl font-bold ${theme === 'dark' ? 'text-pink-400' : 'text-pink-600'}`}
                            >
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-8'>
                    ...
                    >
                        <div
                            className={`text-sm mb-1 font-semibold ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'}`}
                        >
                            Market Volatility
                        </div>
                        <div
                    ...
                    >
                        ...
                        <div
                            className={`text-xs mt-1 capitalize ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}
                        >
                            {powerTrend}
                        </div>
                    </div>

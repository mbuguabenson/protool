    ...
    const helpSections: HelpSection[] = [
        {
            ...
            content: `
        Welcome to analysistoolpro! Here's how to get started:
      ...
      `,
        },
        {
            ...
            content: `
        analysistoolpro generates multiple signal types:
        ...
        <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
                {helpSections.map(section => (
                    ...
                    >
                        <div
                            className={`flex items-center gap-2 mb-2 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`}
                        >
                            {section.icon}
            ...
            >
                ...
                <CardContent>
                    <p
                        className={`whitespace-pre-line text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}
                    >

    ...
    if (!proSignals || proSignals.length === 0) {
        return (
            <div className='space-y-6'>
                ...
                <div
                    className={`soft-card p-6 border-white/5 rounded-xl ${
                        theme === 'dark'
                    ...
                    {showStrategies && (
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
                            {strategies.map((strategy, index) => (
                                ...
                                >
                                    <h4
                                        className={`font-bold mb-2 ${theme === 'dark' ? 'text-amber-400' : 'text-amber-700'}`}
                                    >
                                        {strategy.name}
                                    </h4>
            ...
            {proSignals.map((signal, index) => (
                ...
                >
                    ...
                    <div className='space-y-4'>
                        <div>
                            <div
                                className={`text-sm font-semibold mb-2 ${theme === 'dark' ? 'text-amber-300' : 'text-amber-700'}`}
                            >
                                Recommendation:
                            </div>

...
export function MatchesTab({
    ...
    return (
        <div className='space-y-6'>
            ...
            >
                <h2
                    className={`text-3xl font-bold mb-6 text-center ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                >
                    Matches Analysis
                </h2>
                ...
                >
                    <h3
                        className={`text-lg font-bold mb-4 text-center ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                    >
                        Scan Digit Feature
                    </h3>

    ...
    return (
        <div className='space-y-6'>
            ...
            >
                ...
                >
                    <p
                        className={`text-xs font-semibold mb-1 ${theme === 'dark' ? 'text-purple-300' : 'text-purple-700'}`}
                    >
                        Market Power
                    </p>
                ...
                >
                    <p
                        className={`text-xs font-semibold mb-1 ${theme === 'dark' ? 'text-yellow-300' : 'text-yellow-700'}`}
                    >
                        Volatility
                    </p>
            ...
            >
                <p
                    className={`text-xs sm:text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} leading-relaxed`}
                >
                    <span className='font-bold'>How Money Maker Works:</span> Phase 1 analyzes initial market
                    conditions. If conditions are met, Phase 2 confirms with 15 additional ticks. When confidence
                    reaches 56% or higher with increasing trend, a RUN NOW signal appears (orange with glow). You have
                    maximum 20 ticks to trade. Exit signal appears if market changes or time expires.
                </p>
            </Card>
        </div>
    );

                ...
                <CardContent className='space-y-4 text-slate-300 text-xs sm:text-sm leading-relaxed'>
                    <div>
                        ...
                        <p className='text-slate-400 mb-2 leading-normal'>
                            Point your LLM or AI assistant (such as ChatGPT Custom GPT, Claude Project, Cursor, or
                            Copilot) to the official Deriv LLM metadata file for up-to-date WebSocket and REST
                            configurations:
                        </p>
                    ...
                    <div>
                        <h4 className='text-white font-bold mb-1.5 flex items-center gap-1.5'>
                            <span className='w-1.5 h-1.5 rounded-full bg-indigo-400' /> 2. Model Context Protocol (MCP)
                            Integration
                        </h4>
                        <p className='text-slate-400 mb-3 leading-normal'>
                            Automate tasks by installing the official Deriv MCP server. This allows models to explore
                            active symbols, stream tick histories, check balances, and fetch live endpoints
                            autonomously.
                        </p>

                        <h5 className='text-slate-200 font-bold text-xs uppercase tracking-wider mb-2'>
                            Claude Desktop Configuration
                        </h5>
                        <p className='text-slate-400 mb-2 leading-normal'>
                            Add the following to your{' '}
                            <code className='bg-slate-900 px-1 py-0.5 rounded text-white text-[11px]'>
                                claude_desktop_config.json
                            </code>{' '}
                            under the{' '}
                            <code className='bg-slate-900 px-1 py-0.5 rounded text-white text-[11px]'>mcpServers</code>{' '}
                            section:
                        </p>
      ...
      "env": {
        ...
        "DERIV_APP_ID": "your_app_id_here"
                    ...
                    <div className='pt-2'>
                        ...
                        <p className='text-slate-400 mb-2 leading-normal'>
                            Configure your agent settings manually or connect directly to the Deriv MCP gateway
                            endpoint:
                        </p>
    ...
    "name": "Deriv API"
                    ...
                    <Accordion type='single' collapsible className='w-full'>
                        <AccordionItem value='even-odd' className='border-blue-500/20'>
                            ...
                            <AccordionContent className='text-gray-400'>
                                <p className='mb-2'>
                                    <strong className='text-white'>Entry Rule:</strong> Wait for 2+ consecutive opposite
                                    digits, then trade the favored direction.
                                </p>
                                <p>
                                    <strong className='text-white'>Example:</strong> If Even is at 60%, wait for 2+ Odd
                                    digits, then trade Even.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='over-under' className='border-blue-500/20'>
                            ...
                            <AccordionContent className='text-gray-400'>
                                <p className='mb-2'>
                                    <strong className='text-white'>Entry Rule:</strong> Trade when the strongest digit
                                    appears and over/under bias is strong (62%+).
                                </p>
                                <p>
                                    <strong className='text-white'>Example:</strong> If Over 4.5 is at 65% and digit 7
                                    is strongest, trade Over when 7 appears.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='matches' className='border-blue-500/20'>
                            ...
                            <AccordionContent className='text-gray-400'>
                                <p className='mb-2'>
                                    <strong className='text-white'>Entry Rule:</strong> Trade immediately when the most
                                    frequent digit appears (15%+ frequency).
                                </p>
                                <p>
                                    <strong className='text-white'>Example:</strong> If digit 3 appears 18% of the time,
                                    trade Matches 3 when it appears.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='differs' className='border-blue-500/20'>
                            ...
                            <AccordionContent className='text-gray-400'>
                                <p className='mb-2'>
                                    <strong className='text-white'>Entry Rule:</strong> Wait for the least frequent
                                    digit to appear (&lt;9%), then trade Differs immediately.
                                </p>
                                <p>
                                    <strong className='text-white'>Example:</strong> If digit 5 appears only 6% of the
                                    time, trade Differs 5 when it appears.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='rise-fall' className='border-blue-500/20'>
                            ...
                            <AccordionContent className='text-gray-400'>
                                <p className='mb-2'>
                                    <strong className='text-white'>Entry Rule:</strong> Trade based on Bollinger Bands &
                                    CCI indicators with 60%+ confidence.
                                </p>
                                <p>
                                    <strong className='text-white'>Example:</strong> If price is trending up with 65%
                                    confidence, trade Rise.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
            ...
            <Card className='bg-gradient-to-br from-[#0f1629]/80 to-[#1a2235]/80 border-blue-500/20'>
                ...
                <CardContent className='space-y-4 text-gray-400'>
                    <div>
                        ...
                        <p className='text-sm'>
                            Requires 55%+ Even (or 70%+ Odd) with 2+ high-percentage digits. Wait for 3+ consecutive
                            opposite digits before entering.
                        </p>
                    </div>
                    <div>
                        <h4 className='text-white font-semibold mb-2'>Pro Over/Under Strategy</h4>
                        <p className='text-sm'>
                            Over 1: Requires digits 0 and 1 &lt;10%, with 90%+ Over rate. Under 8: Requires digits 8 and
                            9 &lt;10%, with 90%+ Under rate.
                        </p>
                    </div>
                    <div>
                        <h4 className='text-white font-semibold mb-2'>Pro Differs Strategy</h4>
                        <p className='text-sm'>
                            Target digits with &lt;9% frequency for 88%+ win rate. Wait for the target digit to appear,
                            then trade Differs immediately.
                        </p>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className='bg-gradient-to-br from-[#0f1629]/80 to-[#1a2235]/80 border-blue-500/20'>
                ...
                <CardContent className='text-gray-400 space-y-3'>
                    <p>
                        analysistoolpro is a real-time market analysis platform for Deriv trading. It provides advanced

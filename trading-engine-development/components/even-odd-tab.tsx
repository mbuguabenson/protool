                                ...
                                <div>
                                    <div className='flex justify-between text-xs mb-1'>
                                        ...
                                        <span className='text-blue-400 font-bold'>
                                            {((stats.even / stats.total) * 100).toFixed(0)}%
                                        </span>
                                    </div>
                                    <div className='h-2 bg-[#0a0e27]/50 rounded-full overflow-hidden'>
                                        <div
                                            className='h-full bg-blue-500'
                                            style={{ width: `${(stats.even / stats.total) * 100}%` }}
                                        />
                                    </div>
                                </div>
                                <div>
                                    <div className='flex justify-between text-xs mb-1'>
                                        ...
                                        <span className='text-pink-400 font-bold'>
                                            {((stats.odd / stats.total) * 100).toFixed(0)}%
                                        </span>
                                    </div>
                                    <div className='h-2 bg-[#0a0e27]/50 rounded-full overflow-hidden'>
                                        <div
                                            className='h-full bg-pink-500'
                                            style={{ width: `${(stats.odd / stats.total) * 100}%` }}
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <CardContent className='space-y-4'>
                        ...
                        <div className='p-3 rounded-lg bg-blue-500/10 border border-blue-500/20'>
                            ...
                            <p className='text-xs text-gray-400 mt-1'>
                                of {records.length} total predictions match current filter
                            </p>
                        </div>
                    </CardContent>
                </Card>

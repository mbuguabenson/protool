...
import ScannerV3 from '../scanner-v3';
import { useIsMobile } from '@/hooks/use-mobile';
import './floating-signal-scanner.scss';

const FloatingSignalScanner: React.FC = () => {
    ...
    const handlePointerDown = (e: React.PointerEvent<HTMLDivElement>) => {
        ...
        // Only drag from the header, not internal controls
        ...
        <div className='floating-scanner-container'>
            ...
            {isOpen && (
                <div
                    ...
                    style={isDesktop ? { left: `${position.x}px`, top: `${position.y}px` } : {}}
                ...
                >
                    ...
                    {/* Content area: Native AI Scanner 3.0 */}
                    <div className='floating-scanner__body'>
                        <ScannerV3 isFloating={true} onClose={() => setIsOpen(false)} />
                    </div>
                </div>
            )}
        </div>

                ...
                <div className='text-center'>
                    {isSuccess ? (
                        <>
                            ...
                            <h2
                                className={`text-3xl font-bold mb-2 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`}
                            >
                                Congratulations!
                            </h2>
                            ...
                            <div
                                className={`text-4xl font-bold mb-6 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`}
                            >
                                ${amount.toFixed(2)}
                            </div>
                        ...
                        <>
                            ...
                            <h2
                                className={`text-3xl font-bold mb-2 ${theme === 'dark' ? 'text-red-400' : 'text-red-600'}`}
                            >
                                Oops!
                            </h2>
                            <p className={`text-lg mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                            ...
                            <div
                                className={`text-4xl font-bold mb-6 ${theme === 'dark' ? 'text-red-400' : 'text-red-600'}`}
                            >
                                ${amount.toFixed(2)}
                            </div>
                            <p className={`text-sm mb-6 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>

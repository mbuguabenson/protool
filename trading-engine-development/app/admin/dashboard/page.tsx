                                ...
                                <div className='space-y-4'>
                                    <div className='p-4 rounded-lg bg-blue-500/10 border border-blue-500/20'>
                                        ...
                                        <p className='text-sm text-gray-400 mb-4'>
                                            Update trading strategies for all traders
                                        </p>
                                ...
                                <div className='space-y-3'>
                                    <div className='p-4 rounded-lg bg-blue-500/10 border border-blue-500/20'>
                                        ...
                                        <p className='text-sm text-gray-400'>
                                            This admin panel allows you to configure bot strategies and monitor system
                                            health. Use the Settings tab to update trading parameters.
                                        </p>
                                    </div>
                                    ...
                                    <div className='p-4 rounded-lg bg-blue-500/10 border border-blue-500/20'>
                                        ...
                                        <p className='text-sm text-gray-400'>
                                            Available strategies: Even/Odd, Over/Under, Differs, Rise/Fall. Each
                                            strategy has configurable parameters for signal generation and risk
                                            management.
                                        </p>
                                    </div>
                                    ...
                                    <div className='p-4 rounded-lg bg-blue-500/10 border border-blue-500/20'>
                                        ...
                                        <p className='text-sm text-gray-400'>
                                            Email: mbuguabenson2020@gmail.com | WhatsApp: +254757722344
                                        </p>
                                    </div>
                                </div>
                            </CardContent>

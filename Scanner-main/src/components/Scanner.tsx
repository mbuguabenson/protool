...
const TRADE_TYPES = [
    {
        id: 'over_under',
        label: 'Over / Under',
        types: ['over_under', 'pro_over_under', 'under_7', 'over_2'] as SignalType[],
    },
    ...
    return (
        <div className='space-y-1.5'>
            ...
            <div className='flex items-center gap-2'>
                <span className='text-xs font-black w-10 text-right' style={{ color: leftColor }}>
                    {leftLabel}
                </span>
                <div
                ...
                >
                    <div
                        ...
                        style={{ width: `${leftValue}%`, background: leftColor }}
                    />
                    <div
                        className='absolute right-0 top-0 h-full rounded-full transition-all duration-700'
                        style={{ width: `${rightValue}%`, background: rightColor }}
                    />
                </div>
                <span className='text-xs font-black w-10' style={{ color: rightColor }}>
                    {rightLabel}
                </span>
            </div>
        </div>
        ...
        >
            ...
            >
                ...
                <div className='flex items-center gap-2'>
                    <div className='flex gap-1'>
                        {(['1000', '120', '15'] as const).map(w => {
                            ...
                            return (
                                <span
                                    key={w}
                                    className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${active ? 'text-white' : 'bg-white/5 text-white/30'}`}
                    ...
                    <span className='text-xs font-black' style={{ color: alignColor }}>
                        {mwa.alignmentScore}%
                    </span>
                    <span
                        className='text-[10px] font-bold px-2 py-0.5 rounded-full text-white'
                        style={{ background: alignColor }}
                    >
                        {alignLabel}
                    </span>
                </div>
            ...
            <div className='h-1.5' style={{ background: 'rgba(255,255,255,0.05)' }}>
                <div
                    ...
                    style={{
                        width: `${mwa.alignmentScore}%`,
                        background: `linear-gradient(90deg, ${alignColor}, ${alignColor}cc)`,
                    }}
                />
            </div>
            ...
            <div className='p-4 space-y-4'>
                ...
                {tradeTypeId === 'over_under' && (
                    <StatBar
                        label='Over / Under 4.5'
                        leftLabel='OVER'
                        rightLabel='UNDR'
                        leftValue={a.highPercentage}
                        leftColor='#0ea5e9'
                        rightColor='#f97316'
                    />
                )}
                {tradeTypeId === 'matches' && (
                    <DigitStat
                        label='Strongest Digit'
                        digit={a.powerIndex.strongest}
                        percentage={a.digitFrequencies[a.powerIndex.strongest]?.percentage ?? 0}
                        color='#D61A8C'
                        badge='MATCHES'
                    />
                )}
                {tradeTypeId === 'differs' && (
                    <DigitStat
                        label='Weakest Digit'
                        digit={a.powerIndex.weakest}
                        percentage={a.digitFrequencies[a.powerIndex.weakest]?.percentage ?? 0}
                        color='#64748b'
                        badge='DIFFERS'
                    />
                )}
                        ...
                        return (
                            <div className='flex items-center justify-between'>
                                ...
                                <div
                                    ...
                                    style={{ background: rising ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)' }}
                                >
                                    {rising ? (
                                    ...
                                    <span
                                        ...
                                        style={{ color: rising ? '#10b981' : '#ef4444' }}
                                    >
                    ...
                    <div className='flex items-center justify-between pt-1 border-t border-white/10'>
                        ...
                        <div className='flex items-center gap-1.5'>
                            ...
                            <span className='text-[9px] font-bold text-white/40'>
                                ({mwa.lastDigit % 2 === 0 ? 'EVEN' : 'ODD'} · {mwa.lastDigit >= 5 ? 'HIGH' : 'LOW'})
                            </span>
                        </div>
                    </div>
                )}
                        ...
                        const val =
                            tradeTypeId === 'even_odd'
                                ...
                                : tradeTypeId === 'over_under'
                                  ? wa.highPercentage
                                  : tradeTypeId === 'matches'
                                    ? (wa.digitFrequencies[wa.powerIndex.strongest]?.percentage ?? 0) * 5 || 0
                                    : tradeTypeId === 'differs'
                                      ? 100 - wa.digitFrequencies[wa.powerIndex.weakest]?.percentage
                                      : 50;
                        return (
                            <div
                                key={label}
            ...
            <div className='p-3'>
                <div className='flex items-start gap-2 mb-2'>
                    ...
                    <div className='flex-1 min-w-0'>
                        ...
                        <p className='text-xs font-semibold text-white/70 mt-0.5 leading-snug'>
                ...
                <div className='flex items-start gap-1.5'>
                    ...
                    <p className='text-[10px] text-white/40 leading-snug flex-1'>
                        <span className='font-bold text-white/60'>Entry: </span>
                ...
                {signal.targetDigit !== undefined && (
                    <div
                        className={`mt-2 flex items-center gap-1.5 rounded-xl px-3 py-1.5 border ${entryMatch ? 'bg-green-500/10 border-green-500/30' : 'bg-white/5 border-white/10'}`}
                    >
                        <div
                            className={`w-5 h-5 rounded flex items-center justify-center text-[10px] font-black text-white ${entryMatch ? 'bg-green-500' : 'bg-white/20'}`}
                        >
                            {signal.targetDigit}
                        </div>
                        <span className={`text-[10px] font-bold ${entryMatch ? 'text-green-400' : 'text-white/40'}`}>
                            {entryMatch
                                ? 'Entry digit matches last tick — TRADE NOW!'
                                : `Waiting for digit ${signal.targetDigit}`}
                        </span>
                    </div>
                )}
            </div>
...
export default function Scanner() {
    ...
    const orbEl = (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        'radial-gradient(circle at 40% 30%, #ff4d8d 0%, #D61A8C 40%, #8E44AD 80%, #5a1a6a 100%)',
            ...
            >
                {/* Inner shine */}
                <div
                    className='absolute top-1 left-3 right-3 h-6 rounded-full pointer-events-none'
                ...
                {/* Connection dot */}
                <div
                    className='absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-[#1a0a2e]'
                    style={{
    ...
    const panel = step !== 'orb' && (
        ...
        >
            {/* Header bar */}
            <div
                className='relative px-5 py-4 flex items-center justify-between select-none'
                style={{
            ...
            >
                ...
                <div className='flex items-center gap-1'>
                    <button
                        ...
                        className='w-7 h-7 rounded-full flex items-center justify-center hover:bg-white/10 transition text-white/50 hover:text-white/80'
                    >
                ...
                >
                    ...
                    <div>
                        ...
                        <div className='relative'>
                            ...
                            >
                                ...
                                <ChevronDown
                                    size={14}
                                    className={`text-white/40 transition-transform ${showSymbolPicker ? 'rotate-180' : ''}`}
                                />
                            </button>
                            {showSymbolPicker && (
                                <div
                                    className='absolute z-20 top-full left-0 right-0 mt-1 rounded-xl shadow-2xl overflow-hidden max-h-64 overflow-y-auto'
                                    style={{
                                ...
                                >
                                    {['Volatility', 'Crash/Boom', 'Jump', 'Bear/Bull', 'Range', 'Step'].map(cat => (
                                        <div key={cat}>
                                            <div
                                                className='px-4 py-1.5 text-[10px] font-bold text-white/40 uppercase tracking-wider sticky top-0'
                                                style={{ background: 'rgba(255,255,255,0.06)' }}
                                            >
                                                {cat}
                                            </div>
                                            {SYMBOLS.filter(s => s.category === cat).map(s => (
                                                <button
                                                    ...
                                                    style={
                                                        selectedSymbol === s.id
                                                            ? { background: 'rgba(214,26,140,0.12)' }
                                                            : {}
                                                    }
                                                >
                                                    {s.label}
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        {[
                            ...
                            <div key={label}>
                                <label className='text-[9px] font-bold text-white/50 uppercase tracking-wider block mb-1'>
                                    {label}
                                </label>
                                <input
                                    type='number'
                    ...
                    >
                        ...
                        >
                            <div
                                className={`bg-white w-5 h-5 rounded-full shadow transform transition-transform duration-300 ${multiMarket ? 'translate-x-5' : 'translate-x-0'}`}
                            />
                        </button>
                    </div>
                            ...
                            >
                                ...
                                >
                                    <div
                                        ...
                                        style={{
                                            width: `${(scanProgress / scanTarget) * 100}%`,
                                            background: 'linear-gradient(90deg, #D61A8C, #E67E22)',
                                        }}
                                    />
                                </div>
                            </div>
                            <div
                                className='w-full text-white font-bold text-center py-3 rounded-xl text-xs flex items-center justify-center gap-2'
                        ...
                        <div className='space-y-4'>
                            ...
                            {selectedSignal && (
                                <div
                                    ...
                                    style={{
                                        background:
                                            'linear-gradient(135deg, rgba(214,26,140,0.12), rgba(142,68,173,0.08))',
                                        border: '1.5px solid rgba(214,26,140,0.3)',
                                    }}
                                >
                                    <div className='flex-1 min-w-0'>
                                        <div className='flex items-center gap-1.5 mb-0.5'>
                                    ...
                                    <span
                                        className='shrink-0 text-[10px] font-black px-2.5 py-1 rounded-xl text-white'
                            ...
                            <div className='grid grid-cols-3 gap-2 pt-1'>
                                <button
                                    onClick={resetScan}
                                    className='border rounded-xl text-white/60 text-xs font-black py-3 transition active:scale-95'
                                    style={{
                                ...
                                <button
                                    ...
                                    className='bg-green-500 hover:bg-green-600 text-white text-xs font-black py-3 rounded-xl transition active:scale-95 shadow flex items-center justify-center gap-1'
                                >
                                    <Download size={12} />
                                    Load Bot
                                </button>
                                <button
                                    onClick={handleLoadBot}
                                    className='text-white text-xs font-black py-3 rounded-xl transition active:scale-95 shadow flex items-center justify-center gap-1'
...
function generateBotXML(opts: {
    ...
    if (bestSignal) {
        ...
        if (dir.includes('UNDER 8')) {
            ...
            underDigitNum = 8;
            entryUnderOp = 'GTE';
            entryUnderThreshold = 7;
            overDigitNum = 2;
            entryOverOp = 'LTE';
            entryOverThreshold = 3;

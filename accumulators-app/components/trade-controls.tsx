                    ...
                    <TooltipProvider>
                        <Tooltip>
                            ...
                            <TooltipContent side='top' className='max-w-[200px]'>
                                <p className='text-xs'>
                                    Your stake grows by the selected percentage for each tick that stays within the
                                    barrier range.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                ...
                <div className='flex items-center gap-1.5'>
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            ...
                            <TooltipContent side='top' className='max-w-[200px]'>
                                <p className='text-xs'>
                                    The contract closes automatically when your profit reaches this amount. Leave empty
                                    for no limit.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                ...
                <div className='space-y-1.5 rounded-md border border-border bg-muted/30 p-3 text-xs'>
                    <div className='flex items-center justify-between'>
                        ...
                        <span className='font-medium'>
                            {proposal.maxPayout.toLocaleString('en-US', {
            ...
            {activePosition && (
                <div className='space-y-1.5 rounded-md border border-border bg-muted/30 p-3 text-xs'>
                    <div className='flex items-center justify-between'>
                        ...
                        <span className='font-medium'>
                            {parseFloat(activePosition.buy_price).toFixed(2)} {activePosition.currency}
                        </span>
                    </div>
                    <div className='flex items-center justify-between'>
                        ...
                        >
                            ...
                            {parseFloat(activePosition.profit).toFixed(2)} {activePosition.currency}
                        </span>
                    </div>
                        ...
                        {isClosing ? (
                            ...
                            <span className='flex flex-col items-center leading-tight gap-0.5'>
                                ...
                                <span className='text-xs font-normal opacity-90'>
                                    {(parseFloat(activePosition.buy_price) + parseFloat(activePosition.profit)).toFixed(
                                        2
                                    )}{' '}
                                    {activePosition.currency}
                                </span>
